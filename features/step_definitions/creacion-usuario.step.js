...
Then('se muestra un mensaje confirmando que el usuario ha sido registrado', function () {
...
Then('se muestra un mensaje indicando que todos los campos son obligatorios', function () {
    expect(mensajeRegistro).to.equal('Por favor, complete todos los campos');
});

When('proporciona un correo con formato incorrecto y envía la solicitud', function () {
    nuevoUsuario = {
        nombre: 'Carlos Rivera',
...
Then('se muestra un mensaje indicando “Formato de correo inválido”', function () {
