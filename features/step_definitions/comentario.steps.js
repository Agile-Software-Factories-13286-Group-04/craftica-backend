...
// Escenario 01
Given(
  "el usuario ha iniciado sesión y visualiza una publicación artesanal",
  function () {
...
Then(
  "el sistema guardo el comentario y lo muestra junto a la publicación.",
  function () {
...
// Escenario 02
Given(
  "el usuario está navegando por las publicaciones artesanales",
  function () {
    this.usuarioAutenticado = true;
    publicacionSeleccionada = publicacionesArtesanales[0];
  }
...
Then(
  "el sistema registra la acción y actualiza el contador de “me gusta”.",
  function () {
