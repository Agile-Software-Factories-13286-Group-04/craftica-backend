...
When(
  "proporciona los datos requeridos para crear una publicación (título, descripción, imágenes, precio, categoría " +
    "y producto válido)",
  function () {
    nuevaPublicacion = {
    ...
    if (
      this.autenticado &&
      nuevaPublicacion.imagenes.length > 0 &&
      nuevaPublicacion.productoValido
    ) {
...
Then(
  "el sistema muestra mensaje indicando que debe adjuntar al menos una imagen.",
  function () {
    expect(mensajeErrorPublicacion).to.equal(
...
When(
  "proporciona un producto que no pertenece a la categoría artística o cultural permitida",
  function () {
    nuevaPublicacion = {
...
Then(
  "no se registra la publicación y se muestra una alerta indicando que el producto no es válido",
  function () {
